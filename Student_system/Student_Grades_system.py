...
print("This is the Student Grades Management System. You can view students, add new students, delete students, update student grades, view average grades for each course, and see the top students based on their grades.")